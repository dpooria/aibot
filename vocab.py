...
day_literals ={'روز پیش رو': 1, 'فردا': 1, 'روز بعد': 1, 'روز آینده': 1j, 'امروز': 0, 'فردای': 1, 'دیروز': -1, 'روز پیش': -1, 'روز گذشته': -1, 'روز قبل': -1, 'روز اینده': 1j, 'هفته\u200cی آینده': 7j, 'هفته آینده': 7j, 'هفته اینده': 7j, 'هفته\u200cی اینده': 7j, 'هفته بعد': 7j, 'هفته\u200cی بعد': 7j, 'هفته دیگر': 7j, 'هفته\u200cی دیگر': 7j, 'هفته\u200cی گذشته': (-0-7j), 'هفته گذشته': (-0-7j), 'هفته قبل': (-0-7j), 'هفته\u200cی قبل': (-0-7j), 'هفته پیش': (-0-7j), 'هفته\u200cی پیش': (-0-7j), 'پس\u200cفردا': 2, 'پریروز': -2, 'پس فردا': 2, 'پسفردا': 2, 'روز دیگر': 1, 'روز دیگه': 1, 'روز دیگ': 1, 'شب پیش رو': 1, 'روز آتی': 1, 'امشب': 0, "این هفته":0j}
