...
day_literals = {"روز پیش رو": 1, 'فردا': 1, 'روز بعد': 1, 'روز آینده': 1j, 'امروز': 0, 'فردای': 1, 'دیروز': -1, 'روز پیش': -1, 'روز گذشته': -1, 'روز قبل': -1, 'روز اینده': 1j, 'هفته\u200cی آینده': 7, 'هفته آینده': 7, 'هفته اینده': 7, 'هفته\u200cی اینده': 7, 'هفته بعد': 7, 'هفته\u200cی بعد': 7,
                'هفته دیگر': 7, 'هفته\u200cی دیگر': 7, 'هفته\u200cی گذشته': -7, 'هفته گذشته': -7, 'هفته قبل': -7, 'هفته\u200cی قبل': -7, 'هفته پیش': -7, 'هفته\u200cی پیش': -7, 'پس\u200cفردا': 2, 'پریروز': -2, 'پس فردا': 2, 'پسفردا': 2, 'روز دیگر': 1, 'روز دیگه': 1, 'روز دیگ': 1, "شب پیش رو": 1, "روز آتی": 1, "امشب": 0}
