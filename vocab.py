...
tr_adhan_names = {'اذان صبح': 'Fajr', 'اذان فجر': 'Fajr', 'طلوع آفتاب': 'Sunrise', 'طلوع افتاب': 'Sunrise', 'اذان ظهر': 'Dhuhr', 'اذان عصر': 'Asr', 'اذان مغرب': 'Maghrib', 'اذون صبح': 'Fajr', 'اذون فجر': 'Fajr', 'اذون ظهر': 'Dhuhr', 'اذون عصر': 'Asr', 'اذون مغرب': 'Maghrib', 'اذون عشا': 'Isha', "آذان صبح": "Fajr", "آذان ظهر": "Dhuhr", "آذان مغرب": "Maghrib",
                  'غروب آفتاب': 'Sunset', 'غروب افتاب': 'Sunset', 'نیمه شب شرعی': 'Midnight', 'نیمه\u200cشب شرعی': 'Midnight', 'امساک': 'Imsak', 'طلوع خورشید': 'Sunrise', 'غروب خورشید': 'Sunset', 'نماز صبح': 'Fajr', 'نماز ظهر': 'Dhuhr', 'نماز عصر': 'Asr', 'نماز مغرب': 'Maghrib', 'نماز عشا': 'Isha', 'نصف شب': 'Isha', "خورشید طلوع": "Sunrise", "خورشید غروب": "Sunset", "اذان‌صبح": "Fajr", "اذان‌ظهر": "Dhuhr"}
...
day_literals = {"روز پیش رو": 1, 'فردا': 1, 'روز بعد': 1, 'روز آینده': 1, 'امروز': 0, 'فردای': 1, 'دیروز': -1, 'روز پیش': -1, 'روز گذشته': -1, 'روز قبل': -1, 'روز اینده': 1, 'هفته\u200cی آینده': 7, 'هفته آینده': 7, 'هفته اینده': 7, 'هفته\u200cی اینده': 7, 'هفته بعد': 7, 'هفته\u200cی بعد': 7,
                'هفته دیگر': 7, 'هفته\u200cی دیگر': 7, 'هفته\u200cی گذشته': -7, 'هفته گذشته': -7, 'هفته قبل': -7, 'هفته\u200cی قبل': -7, 'هفته پیش': -7, 'هفته\u200cی پیش': -7, 'پس\u200cفردا': 2, 'پریروز': -2, 'پس فردا': 2, 'پسفردا': 2, 'روز دیگر': 1, 'روز دیگه': 1, 'روز دیگ': 1, "شب پیش رو": 1, "روز آتی": 1}
