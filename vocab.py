...
weather_description_asked = ['چطور', 'چگونه', 'چه طور', 'چه\u200cطور', 'بارانی',
                             'برفی', 'ابری', 'آفتابی', 'طوفانی', 'چه وضعی', 'چه\u200cصورت', 'چه صورت']
...
tr_adhan_names = {'اذان صبح': 'Fajr', 'اذان فجر': 'Fajr', 'طلوع آفتاب': 'Sunrise', 'طلوع افتاب': 'Sunrise', 'اذان ظهر': 'Dhuhr', 'اذان عصر': 'Asr', 'اذان مغرب': 'Maghrib', 'اذون صبح': 'Fajr', 'اذون فجر': 'Fajr', 'اذون ظهر': 'Dhuhr', 'اذون عصر': 'Asr', 'اذون مغرب': 'Maghrib', 'اذون عشا': 'Isha',
