...
time_literals = {'ساعت قبل': -1, 'ساعت گذشته': -1, 'ساعت پیش': -1, 'ساعت آینده': 1, 'ساعت اینده': 1, 'ساعت بعد': 1, 'ساعت دیگر': 1, 'دقیقه بعد': 0.016666666666666666, 'دقیقه آینده': 0.016666666666666666, 'دقیقه اینده': 0.016666666666666666, 'دقیقه\u200cی بعد': 0.016666666666666666, 'دقیقه\u200cی آینده': 0.016666666666666666, 'دقیقه\u200cی اینده': 0.016666666666666666, 'دقیقه قبل': -
                 0.016666666666666666, 'دقیقه گذشته': -0.016666666666666666, 'دقیقه پیش': -0.016666666666666666, 'دقیقه\u200cی گذشته': -0.016666666666666666, 'دقیقه\u200cی قبل': -0.016666666666666666, 'دقیقه\u200cی پیش': -0.016666666666666666, 'دقیقه\u200cی دیگر': 0.016666666666666666, 'دقیقه دیگر': 0.016666666666666666, 'الان': 0, 'همین الآن': 0, 'همین حالا': 0, 'همین الان': 0, 'این لحظه': 0, 'این ساعت': 0, "ساعت دیگه": 1, "دقیقه دیگه": 1.0/60}
...
miladimonthes = {"جون": 6, 'ژانویه': 1, 'فوریه': 2, 'مارس': 3, 'آوریل': 4, 'آپریل': 4, 'مارچ': 3, 'مه': 5, 'می': 5, 'ژوئن': 6, 'ژون': 6,
...
loc_literals = ['روستای', 'شهرستان', 'شهر', 'کشور', 'استان',
                'مکان', 'ده', 'دهکده', 'دهات', 'منطقه', 'بندر', 'روستا', 'جزیره', "مرکز", "پایتخت", "کشور"]


loc_literals2 = ["مرکز", "استان", "کشور", "پایتخت"]
...
convert_asked = {'به قمری': 2, 'به شمسی': 0, 'به میلادی': 1, 'به تاریخ هجری': 2, 'به تاریخ شمسی': 0, 'به تاریخ میلادی': 1, 'چندم قمری': 2, 'چندم شمسی': 0, 'چندم میلادی': 1,
                 'تاریخ شمسی': 0, 'تاریخ قمری': 2, 'تاریخ میلادی': 1, 'چندم هجری قمری': 2, 'تاریخ هجری قمری': 2, 'روز میلادی': 1, 'روز شمسی': 0, 'روز هجری قمری': 2, 'روز قمری': 2, 'روز هجری': 2, "به هجری شمسی": 0, "به هجری قمری": 2}
...
num2fa_gen = {1: "aیکمِ", 2: "دومa", 3: "سومa", 4: "چهارمa", 5: "پنجمa", 6: "ششمa", 7: "هفتمa", 8: "هشتمa", 9: "نهمa", 10: "دهمa", 11: "یازدهمa", 12: "دوازدهمa", 13: "سیزدهمa", 14: "چهاردهمa", 15: "پانزدهمa", 16: "شانزدهمa", 17: "هفدهمa", 18: "aهجدهم",
              19: "aنوزدهم", 20: "بیستمa", 21: "بیست و یکمa", 22: "بیست و دومa", 23: "بیست و سومa", 24: "بیست و چهارمa", 25: "aبیست و پنجم", 26: "بیست و ششمa", 27: "بیست و هفتمa", 28: "بیست و هشتمa", 29: "بیست و نهمa", 30: "سی‌امa", 31: "سی و یکم", }


before_events = ["روز جهانی", "سالروز", "سالگرد", "روز"]

time_reverse_convert = ["به وقت تهران",
                        "به وقت ایران", "به ساعت تهران", "به ساعت ایران"]


tr_null_cities = {"کیش":"Kish"}
